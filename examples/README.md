...
| ------------------------ | -------------------------------- | -------------------------------- | ---------------------- | ---------------------- |
| [`Varusai-Sci-Rep-2018-....omex`](https://github.com/biosimulators/Biosimulators_test_suite/raw/dev/examples/Varusai-Sci-Rep-2018-mTOR-signaling-LSODA-LSODAR-SBML.omex) | non-spatial continuous (0000293) | LSODA/LSODAR (0000560)           | SBML (format_2585)     | [COPASI](https://biosimulators.org/simulators/copasi)                  |
| [`Vilar-PNAS-2002-...omex`](https://github.com/biosimulators/Biosimulators_test_suite/raw/dev/examples/Vilar-PNAS-2002-minimal-circardian-clock.omex) | non-spatial continuous (0000293), non-spatial discrete (0000295) | CVODE (0000019), Forward Euler (0000030), NRM (0000027)           | SBML (format_2585)     | [VCell](https://biosimulators.org/simulators/vcell)                 |
