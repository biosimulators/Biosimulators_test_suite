...
__all__ = [
    ...
    'SimulatorReportsTheStatusOfTheExecutionOfSedTasksAndOutputs',
]
...
class SimulatorReportsTheStatusOfTheExecutionOfSedTasksAndOutputs(SingleMasterSedDocumentCombineArchiveTestCase):
    """ Test that when a COMBINE/OMEX archive defines a (single) master file, the simulator only
    executes this file.
    """
