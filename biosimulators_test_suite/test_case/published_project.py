...
class SyntheticCombineArchiveTestCase(TestCase):
    ...
    def eval(self, specifications, synthetic_archives_dir=None, dry_run=False):
        ...
        """
        try:
            return_value = self._eval(specifications, synthetic_archives_dir=synthetic_archives_dir, dry_run=dry_run)
        except Exception as exception:
    ...
    def _eval(self, specifications, synthetic_archives_dir=None, dry_run=False):
        """ Evaluate a simulator's performance on a test case
    ...
    def _eval_synthetic_archive(self, specifications, expected_results_of_synthetic_archive, shared_archive_dir,
                                i_synthetic_archive, synthetic_archives_dir=None, dry_run=False):
