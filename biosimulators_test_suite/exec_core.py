...
class SimulatorValidator(object):
    ...
    def __init__(self, specifications: Union[str, JSONType], case_ids: "list[str]" = None, verbose: bool = False, synthetic_archives_dir: str = None,
        ...
        Args:
            specifications (:obj:`str` or :obj:`dict`): path or URL to the specifications of the simulator, or the specifications of the simulator
            case_ids (:obj:`list` of :obj:`str`, optional): List of ids of test cases to verify. If :obj:`case_ids`
        ...
        self.specifications: JSONType = biosimulators_utils.simulator.io.read_simulator_specs(
            specifications, validate=validate_specs) if isinstance(specifications, str) else specifications
